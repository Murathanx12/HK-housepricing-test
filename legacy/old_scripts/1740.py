"""
Hong Kong Rental Price Prediction — v3 (clean)
================================================
Simple & effective: hierarchical stats + KNN + single LightGBM.
Key feature: unit_floorcat (building+tower+flat+floor_category).
"""
...
# ─────────────────────────────────────────────
# 3. HIERARCHICAL STATS
# ─────────────────────────────────────────────
print("Computing stats...")

def compute_stats(grp_col, prefix):
...
# Merge all
for df in [train, test]:
    for stats, key in [(ufc_stats, "unit_floorcat"), (unit_stats, "unit_key"),
...
# Cascading fallback
for chain in [("ufc", "unit", "bt", "bf", "bld", "dist"),
              ("unit", "bt", "bf", "bld", "dist"),
...
feature_cols = [
    ...
    # Predictions
    "pred_ufc", "pred_unit", "pred_bt", "pred_bf", "pred_bld", "pred_dist",
    "pred_bld_floor_adj", "pred_knn5",
    # Derived
